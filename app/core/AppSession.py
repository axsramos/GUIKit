...
class AppSession:
    def __init__(self) -> None:
        ...
        self.user_password = csCoreConfig.get_block_item('SESSION', 'user_password')
        self.required = csCoreConfig.get_block_item('SESSION', 'login_required')
    ...
    def single_login(self, sdtLogin):
        ...
        if (sdtLogin['UsrLgn'] == self.user_name and hash_pwd == self.user_password):
            status_connected = self.set_status_connected(self.user_name, self.user_password)
